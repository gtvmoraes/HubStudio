...
export default function DevYouTubePost() {
  ...
  const handlePublish = async () => {
    ...
    setResult(null)
    setUploadProgress(0)
    addLog(`POST → ${apiBase}/posts/publish/youtube/video`)
    ...
    xhr.upload.addEventListener('load', () => {
      ...
      setStep('processing')
      addLog('Arquivo enviado — backend fazendo upload para o YouTube…', 'info')
    })
    ...
    xhr.open('POST', `${apiBase}/posts/publish/youtube/video`)
